...
namespace ManoelSystemMVC.Controllers
{
    public class ProfessorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDProfessor,Nome,Telefone,Materia,Salario,TwitterBlog,Disponivel,Admissao")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDProfessor,Nome,Telefone,Materia,Salario,TwitterBlog,Disponivel,Admissao")] Professor professor)
        {
            if (ModelState.IsValid)
            {
